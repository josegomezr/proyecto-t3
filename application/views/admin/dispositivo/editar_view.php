            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" readonly id="id_dispositivo" value="<?php echo $dispositivo->id_dispositivo; ?>" name="id_dispositivo">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_recorrido" required class="form-control" id="id_recorrido">
                            ...
                            <?php foreach ($recorridos as $recorrido): ?>
                                <option value="<?php echo $recorrido->id_recorrido ?>" <?php echo ($recorrido->id_recorrido == $dispositivo->id_recorrido) ? 'selected="selected"' : '' ?>><?php echo $recorrido->nombre_recorrido ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                </div>
