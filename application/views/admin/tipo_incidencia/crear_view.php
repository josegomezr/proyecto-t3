...
<div class="col-xs-12 col-sm-8 col-md-9" id="main_content">
    <form method="post">
        ...
        <div class="form-group <?php echo Form\has_error('descripcion_tipo_incidencia') ? 'has-error' :'' ?>">
            ...
            <input type="text" name="descripcion_tipo_incidencia" id="descripcion_tipo_incidencia" minlength="5" maxlength="30" class="form-control" autofocus required value="<?php echo Form\set_value('descripcion_tipo_incidencia') ?>" >
