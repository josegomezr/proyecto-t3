            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="id_tipo_incidencia" required class="form-control" id="id_tipo_incidencia" autofocus>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group <?php echo Form\has_error('descripcion_incidencia') ? 'has-error' :'' ?>">
                        ...
                        <textarea name="descripcion_incidencia" id="descripcion_incidencia" maxlength="150" class="form-control" required rows="3"><?php echo Form\set_value('descripcion_incidencia', $incidencia->descripcion_incidencia) ?></textarea>
